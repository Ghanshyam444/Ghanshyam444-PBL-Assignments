/*Write a program to maintain an employee database 
in binary file with employee information such as 
empId, name, age, department, post and salary. 
Write function for adding new record, displaying all records, 
